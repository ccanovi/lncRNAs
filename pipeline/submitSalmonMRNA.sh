...
ref=/mnt/picea/storage/reference/Picea-abies/v1.0/indices/salmon/Pabies1.0-all-phase.gff3.CDSandLTR-TE_salmon-version-0dot14dot1
bind=/mnt:/mnt
...
for f in $(find $in -name "P7614*_trimmomatic_1.fq.gz"); do
