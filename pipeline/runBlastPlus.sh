...
if [ ! -f $3 ]; then
    echo "The third argument needs to be the fasta file"
    usage
fi

if [ ! -f $4.$EXT ] && [ ! -f $4.${EXT//hr/al} ]; then
    echo "The fourth argument needs to be the basename of the BLAST index - including the path"
    usage
fi

if [ ! -d $5 ]; then
    echo "The fifth argument needs to be the output directory"
    usage
fi
