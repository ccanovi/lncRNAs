...
#trmap Cuffmerge
trmap_oth_t <- read_table2("data/trmap/trinity/transloc/trmap.fasta_filt",
...
trmap_tot <- rbind(trmap_oth_u,trmap_oth_m,trmap_oth_t)
trmap_u_tot <- trmap_tot %>% filter(type != "=" &
                                    type != "c" &
                                    type != "k" &
                                    type != "m" &
                                    type != "n" &
...
random <- trmap_tot %>% filter(type == "p")
